...
fun SignInScreen(
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = R.drawable.shortvideo_logo),
            contentDescription = "Logo"
        )

        Text(
            text = "Đăng nhập Short",
            fontSize = 35.sp,
        ...
        Button(
            ...
            Text("Đăng nhập", Modifier.padding(vertical = 8.dp))
        }
        Divider(
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            Text("Bạn chưa có tài khoản ?", color = Color.White)
            TextButton(
                onClick = { onSignUp() },
            ) {
                Text("Đăng ký")
